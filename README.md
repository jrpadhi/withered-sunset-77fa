...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/withered-sunset-77fa#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/withered-sunset-77fa
```

A live public deployment of this template is available at [https://withered-sunset-77fa.templates.workers.dev](https://withered-sunset-77fa.templates.workers.dev)
